...
<section class="section service-2">
	<div class="container">
		...
		<div class="row">
			<div v-for="department in departments" :key="department.id" class="col-lg-4 col-md-6 ">
				<div class="department-block mb-5">
					<img src="http://127.0.0.1:8000/theme/images/service/service-1.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">{{department.department}}</h4>
